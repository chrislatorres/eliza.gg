---
title: "PR #999: feat: allow users to configure models for openai and anthropic"
date: "2024-12-12T01:22:35.000Z"
author: "oxSaturn"
type: "technical-update"
slug: "pr-999-feat-allow-users-to-configure-models-for-openai-and-anthropic"
published: true
---
...
**Author**: @oxSaturn
**Pull Request**: [#999](https://github.com/ai16z/eliza/pull/999)
...
### Changes Overview
- `.env.example`: 9 changes (+9 -0)
- `packages/core/src/models.ts`: 16 changes (+8 -8)

### Technical Impact
This change impacts the following areas:
- .env.example: 9 changes
- packages: 16 changes
</DiscussionSection>
